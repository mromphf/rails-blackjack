...
describe CardSerializer do
  it "can serialize an array of cards with an ace" do
    cards = [Card.new(3, :hearts), Card.new(11, :clubs), Card.new(1, :hearts)]
  ...
  it "can deserialize an array of cards with an ace" do
    ...
    expect(CardSerializer.deserialize(serialized)).to eq [Card.new(3, :hearts), Card.new(11, :clubs), Card.new(1, :spades)]
  end
end
